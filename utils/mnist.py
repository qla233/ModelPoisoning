...
def data_mnist(one_hot=True):
    ...
    if gv.args.dataset == 'MNIST':
        ...
        X_train, y_train = load_fmnist('/home/bchen/posion/ModelPoisoning/fashion-mnist/data/fashion', kind='train')
        X_test, y_test = load_fmnist('/home/bchen/posion/ModelPoisoning/fashion-mnist/data/fashion', kind='t10k')
